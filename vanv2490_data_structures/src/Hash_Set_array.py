...
class Hash_Set:
    ...
    def __contains__(self, key):
        ...
        found = False
        i = 0
        while i < len(self._table) and not found:
            j = 0
            while j < len(self._table[i]) and not found:
    ...
    def is_identical(self, target):
        ...
        if len(self) != len(target):
            ...
            zero = False
        while i < len(self._table) and identical and zero:
            j = 0
            if len(self._table[i]) != len(target._table[i]):
                identical = False
            while j < len(self._table[i]) and identical:
